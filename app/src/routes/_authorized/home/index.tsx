          ...
          <div className="flex-1 p-4">
            ...
            <div className="space-y-1">
              <SidebarItem
                ...
                active
              />
              <SidebarItem icon={<CheckCircle2 size={17} />} label="My Tasks" />
              <SidebarItem icon={<CalendarDays size={17} />} label="Calendar" />
            </div>
            {/* Projects */}
            <div className="mt-9">
              <div className="mb-2 flex items-center justify-between px-3">
                ...
                <button className="text-neutral-600 transition hover:text-white">
                  <Plus size={15} />
                </button>
              </div>
              <div className="space-y-1">
